...
//           axios.get("${API_BASE_URL}/api/dashboard/total-users", { withCredentials: true }),
//           axios.get("${API_BASE_URL}/api/dashboard/total-revenue", { withCredentials: true }),
//           axios.get("${API_BASE_URL}/api/dashboard/total-orders", { withCredentials: true }),
//         ]);
...
//       try {
//         const res = await axios.get("${API_BASE_URL}/api/orders/stats", { withCredentials: true });
...
//       try {
//         const res = await axios.get("${API_BASE_URL}/api/orders/sales", { withCredentials: true });
//         const data = [
