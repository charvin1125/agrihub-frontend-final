...
//     try {
//       await axios.post(
//         `${API_BASE_URL}/api/review/products/${id}/product-review`,
//         reviewData,
//         { withCredentials: true }
//       );
...
//                 <CardMedia
//                   component="img"
//                   image={selectedImage ? `${API_BASE_URL}/${selectedImage}` : "https://via.placeholder.com/400x400?text=No+Image"}
//                   alt={product.name}
//                   sx={{
...
//     e.preventDefault();
//     try {
//       await axios.post(`${API_BASE_URL}/api/review/products/${id}/product-review`, reviewData, { withCredentials: true });
          ...
          <Grid container spacing={{ xs: 2, sm: 3, md: 4 }}>
            <Grid item xs={12} md={6}>
              <Card>
                <Box
                  sx={{
                    height: { xs: 250, sm: 350, md: 450 }, // Fixed height for image container
                ...
                >
                  <CardMedia
                    component="img"
                    image={selectedImage ? `${API_BASE_URL}/${selectedImage}` : "https://via.placeholder.com/234x234?text=No+Image"}
                    alt={product.name}
                    sx={{
