...
//     try {
//       const response = await axios.get("${API_BASE_URL}/api/category/list", { withCredentials: true });
...
//     try {
//       if (isEditing) {
//         await axios.put(`${API_BASE_URL}/api/category/${editId}`, category, { withCredentials: true });
//         alert("Category updated successfully!");
//         setIsEditing(false);
//         setEditId(null);
//       } else {
//         await axios.post("${API_BASE_URL}/api/category/add", category, { withCredentials: true });
...
//       try {
//         await axios.delete(`${API_BASE_URL}/api/category/${id}`, { withCredentials: true });
...
//     }
//     try {
//       await axios.delete(`${API_BASE_URL}/api/category/${categoryToDelete}`, { withCredentials: true });
...
//     link.click();
//     window.URL.revokeObjectURL(url);
//     toast.success("Categories exported successfully!", { position: "top-center" });
//   };
...
const ManageCategory = () => {
  ...
  const handleSearch = (e) => {
    ...
    const filtered = categories.filter(
      (c) =>
        c.name.toLowerCase().includes(searchTerm) || c.description.toLowerCase().includes(searchTerm)
    );
    setFilteredCategories(filtered);
    setCurrentPage(1);
  };
