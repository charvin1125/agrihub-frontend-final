...
//       try {
//         const res = await axios.get(`${API_BASE_URL}/api/product/${id}`, { withCredentials: true });
...
//       await axios.put(`${API_BASE_URL}/api/product/update/${id}`, formData, {
...
//       try {
//         await axios.delete(`${API_BASE_URL}/api/product/delete/${id}`, { withCredentials: true });
...
//           axios.get(`${API_BASE_URL}/api/product/${id}`, { withCredentials: true }),
//           Promise.all([
//             axios.get("${API_BASE_URL}/api/category/list", { withCredentials: true }),
//             axios.get("${API_BASE_URL}/api/vendor/list", { withCredentials: true }),
//           ]),
...
//       const response = await axios.put(`${API_BASE_URL}/api/product/update/${id}`, formData, {
//         withCredentials: true,
//         headers: { "Content-Type": "multipart/form-data" },
//       });
